...
export default function MapPage() {
  ...
  const makeMarkerContent = (point: RoutePoint, color: string, showPulse = false) => {
    ...
    const pulseDiv = activePulse ? `
      ...
      <div data-pulse="${pulseId}-1" data-delay="500" style="position:absolute;top:50%;left:50%;width:28px;height:28px;margin-left:-14px;margin-top:-14px;border-radius:50%;border:1.5px solid ${pulseColor};background:rgba(255,107,53,0.1);pointer-events:none;will-change:transform,opacity;transform-origin:center center;"></div>
      <div data-pulse="${pulseId}-2" data-delay="1000" style="position:absolute;top:50%;left:50%;width:28px;height:28px;margin-left:-14px;margin-top:-14px;border-radius:50%;border:1.5px solid ${pulseColor};background:rgba(255,107,53,0.1);pointer-events:none;will-change:transform,opacity;transform-origin:center center;"></div>
      <div data-pulse="${pulseId}-3" data-delay="1500" style="position:absolute;top:50%;left:50%;width:28px;height:28px;margin-left:-14px;margin-top:-14px;border-radius:50%;border:1.5px solid ${pulseColor};background:rgba(255,107,53,0.1);pointer-events:none;will-change:transform,opacity;transform-origin:center center;"></div>` : '';
